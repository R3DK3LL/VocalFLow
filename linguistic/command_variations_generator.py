    ...
    def __init__(self):
        self.variations = {
            "browser_operations": {
                "patterns": {
                    "open_browser": {
                        "uk": ["open the browser", "fire up browser", "get browser going", "bring browser up", 
                               "start the browser", "launch browser please", "get on the internet"],
                        "us": ["pull up browser", "boot up browser", "get browser running", "fire up the browser",
                               "bring up browser", "start browser up", "get on the web"],
                        "aus_nz": ["chuck open the browser", "bring up browser", "get on the browser",
                                   "fire up the browser mate", "get browser happening", "open up browser"],
                        "casual": ["browser", "firefox", "chrome", "internet", "web", "online"],
                        "formal": ["please open browser", "launch web browser", "initiate browser application"],
                        "colloquial": ["get me online", "hop on the internet", "web time", "browsing time"]
                    },
                    "close_browser": {
                        "uk": ["close the browser", "shut browser", "close browser down", "finish with browser"],
                        "us": ["shut down browser", "close browser out", "kill the browser", "end browser"],
                        "aus_nz": ["shut browser down", "close browser off", "finish browser"],
                        "casual": ["close browser", "quit browser", "browser off"],
                        "formal": ["terminate browser session", "close browser application"]
                    }
                },
            ...
            "file_operations": {
                "patterns": {
                    "save_file": {
                        "uk": ["save this file", "file save", "put this away", "save this document",
                               "store this file", "keep this file", "file this away"],
                        "us": ["save it up", "file this away", "store this", "put this in a file",
                               "save this out", "file it", "keep this"],
                        "aus_nz": ["save it", "chuck it in a file", "file this", "put this away",
                                   "save this thing", "keep this"],
                        "casual": ["save", "ctrl s", "file save", "keep it"],
                        "formal": ["save current document", "store this file", "preserve this document"],
                        "urgent": ["save now", "quick save", "save this quick", "emergency save"]
                    },
                    "open_file": {
                        "uk": ["open the file", "bring up file", "get file open", "load this file"],
                        "us": ["pull up file", "open file up", "load file", "get this file"],
                        "aus_nz": ["chuck open the file", "get file going", "open this file up"],
            ...
            "text_operations": {
                "patterns": {
                    "select_all": {
                        "uk": ["select the lot", "highlight everything", "select all text",
                               "choose everything", "mark all text", "select the whole thing"],
                        "us": ["select everything", "highlight all this stuff", "mark all",
                               "choose all this", "select all this text", "grab everything"],
                        "aus_nz": ["grab everything", "select the whole lot", "highlight all this",
                                   "mark the lot", "select all this stuff"],
                        "casual": ["ctrl a", "select all", "all of it", "everything"],
                        "formal": ["select entire document", "highlight all content", "mark complete text"]
                    },
                    "copy_text": {
                        "uk": ["copy all of it", "copy this text", "copy the lot", "duplicate this"],
                        "us": ["copy all this stuff", "copy everything", "duplicate all this"],
                        "aus_nz": ["copy all this", "copy the whole thing", "duplicate this lot"],
                        "casual": ["copy", "ctrl c", "copy all", "copy this"],
                        "formal": ["duplicate selected text", "copy current selection"]
                    },
                    "paste_text": {
                        "uk": ["paste it here", "put it here", "paste this text", "stick it here"],
                        "us": ["paste it", "put this here", "paste all this", "drop it here"],
            ...
            "system_operations": {
                "patterns": {
                    "volume_control": {
                        "uk": ["turn volume up", "make it louder", "volume higher", "increase sound",
                               "pump up volume", "crank it up", "louder please"],
                        "us": ["volume up", "turn it up", "make it loud", "pump the volume",
                               "crank up sound", "boost volume", "louder"],
                        "aus_nz": ["turn it up mate", "crank the volume", "make it louder",
                                   "pump it up", "volume higher"],
                        "casual": ["louder", "volume up", "turn up", "up"],
                        "formal": ["increase audio level", "raise volume setting"]
                    },
                    "screenshot": {
                        "uk": ["take a screenshot", "capture screen", "screen grab", "take picture of screen"],
                        "us": ["screenshot this", "capture the screen", "grab screen", "snap the screen"],
                        "aus_nz": ["grab a screenshot", "snap the screen", "capture this screen"],
            ...
            "navigation_operations": {
                "patterns": {
                    "scroll_operations": {
                        "uk": ["scroll down", "move down page", "go down", "page down", "scroll lower"],
    ...
    def generate_comprehensive_patterns(self) -> Dict:
        ...
        for category, data in self.variations.items():
            ...
            for command_type, variations in data["patterns"].items():
                ...
                enhanced_variations = self._add_speech_pattern_variations(all_variations)
                ...
                category_patterns[command_type] = {
                    ...
                    "confidence_threshold": self._get_confidence_threshold(command_type)
                }
