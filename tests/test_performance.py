...
def main():
    ...
    try:
        ...
        print(f"- Average command processing: {sum(processing_times)/len(processing_times):.4f}s")
        print(f"- Memory overhead: {memory_stats['after_init'] - memory_stats['baseline']:.2f} MB")
